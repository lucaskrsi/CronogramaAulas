...
const get_all_1 = require("./disponibilidadeProfessor/get-all");
const get_1 = require("./disponibilidadeProfessor/get");
const remove_1 = require("./disponibilidadeProfessor/remove");
const update_1 = require("./disponibilidadeProfessor/update");
const create_1 = require("./disponibilidadeProfessor/create");
