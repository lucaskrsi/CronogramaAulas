...
function create(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const disponibilidadeProfessor = yield disponibilidadeProfessorRepository.create(new DisponibilidadeProfessor_1.DisponibilidadeProfessor(diaDaSemana, inicioHora, fimHora, professor));
            res.status(201).json({
                data: {
